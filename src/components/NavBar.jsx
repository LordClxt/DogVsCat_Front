...
export const NavBar = ()=>{
    return (
        <div className="relative border-b flex justify-between items-center py-5 border-blue-950 px-2 md:px-10">
            ...
            <a className="flex items-center text-sm md:text-base gap-3 bg-blue-700 text-white font-bold px-4 md:px-8 py-1 rounded hover:bg-blue-800 transition-all" href="https://github.com/KingClxt/FastApiModel">
